...
export class FormEditEmail extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
      ...
      await axios
        ...
        .then(response => {
          ...
          if (data.data != null) {
            ...
            this.setState({
              alertData: 'Email gagal diubah  ' + data.message,
        ...
        <View showsVerticalScrollIndicator={false} style={styles.scroll}>
          ...
          <View>
            <TouchableOpacity
              ...
              onPress={() =>
                this.setState({
                  alertDelete: 'Apakah yakin ingin mengganti email anda?',
                  modalDelete: !this.state.modalDelete,
                })
              }>
              <Text
...
export default connect(mapStateToProps, mapDispatchToProps)(FormEditEmail);
