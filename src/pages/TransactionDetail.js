...
export class TransactionDetail extends Component {
    ...
    try {
      ...
      if (data['success'] === true) {
        this._isMounted &&
          ...
          console.log(
            'Data tracking ' + JSON.stringify(data.data),
          );
      } else {
        console.log(
  ...
  render() {
    //countdown transfer pembayaran

    // let currentDate = moment();
    // let endPayment = moment(order.updated_at).add(1, 'days');
          ...
          <ScrollView
            ...
            <View
              ...
              <View
                ...
                {/* <TouchableOpacity
                    onPress={() =>  this.props.navigation.navigate("DetailStatusPesanan")}
                  >
                    <Text
                      style={[
                        styles.textEdit,
                        {color: '#529F45', alignSelf: 'flex-end'},
                      ]}>
                      Detail status
                    </Text>
                  </TouchableOpacity> */}
              ...
              {order.invoice != '' ? (
                <View>
                  <View
                    ...
                    <Text style={[styles.textEdit]}>{order.invoice}</Text>
                  </View>
                  <Card.Divider />
                </View>
              ) : null}
              ...
              {/* upload pembayaran
                            {order.status === '2' && order.payment_method === 'transfer' && order.payment_link === null && (
                                <View
                                    style={[
                                        styles.position2,
                                        {
                                    ...
                                    <View style={styles.textposition}>
                                        <Text style={[styles.textEdit, { color: '#777' }]}>
                                    ...
                                    <View
                                        ...
                                        {this.state.CountDownText == null && (
                                            <CountDown
                                                size={18}
                                                until={totalDurationPayment}
                                                onFinish={() => {
                                                    this.setState({
                                                        CountDownText: (<Text style={{ color: '#E07126', width: wp('4%'0), textAlign: 'auto', marginRight: wp('5%') }} numberOfLines={4}
                                                            multiline>Waktu pembayaran telah habis. Silahkan melakukan order kembali</Text>)
                                                    })
                                                }}
                                                digitStyle={{ backgroundColor: '#FFF' }}
                                                digitTxtStyle={{ color: '#E07126' }}
                                                separatorStyle={{ color: '#E07126' }}
                                                timeToShow={['H', 'M', 'S']}
            ...
            <View
              ...
              {/* <Card.Divider style={{marginTop: wp('3%')}} /> */}
