...
export class HelpCareCategoryDetail extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  //help care account
  getHelpCareAccount = async () => {
    try {
      let response = await axios.get(
        `${CONFIG.BASE_URL}/api/helps?category_id=${this.props.route.params.id}`,
        {
