...
export class BannerYoutube extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Text style={styles.title}>Video Untukmu</Text>
        {/* <View style={styles.container}> */}
...
export default connect(mapStateToProps, mapDispatchToProps)(BannerYoutube);
