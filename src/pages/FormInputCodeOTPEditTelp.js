...
export class FormInputCodeOTPEditTelp extends Component {
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  sendOTPWA = async () => {
    ...
    try {
      let response = await axios.post(
        `${CONFIG.BASE_URL}/api/otp/phone-number/wa`,
        formData,
        // {
      ...
      if (data !== '' && data['success'] == true) {
        ...
        this.props.navigation.navigate('FormVerifikasiEditTeleponWA');
  ...
  sendOTPSMS = async () => {
    ...
    try {
      ...
      if (data !== '' && data['success'] == true) {
        console.log('HASIL SEND OTP', data.data);
        this.props.navigation.navigate('FormVerifikasiEditTelepon');
        this.setState({loadingApi: false});
      } else {
        console.log('', typeof data);
        this.setState({
    ...
    return (
      <View showsVerticalScrollIndicator={false} style={styles.scroll}>
        ...
        <View style={[styles.container]}>
          ...
          />
          <Text style={styles.text}>{'Pilih metode verifikasi'}</Text>
        </View>
