    ...
    createNotificationListeners = (onRegister, onNotification, onOpenNotification, navigation) => {
        ...
        messaging()
            .onNotificationOpenedApp(async remoteMessage => {
                console.log("[FCM Service] onNotificationOpenedApp Notification caused app to open"+remoteMessage)
                try {
                    console.log("[FCM Service] onNotificationOpenedApp Notification caused app to open"+remoteMessage)
                    if (remoteMessage) {
        ...
        messaging()
            ...
            .then(async remoteMessage => {
                try {
                    ...
                    if (remoteMessage) {
                        // const notification = remoteMessage.notification
                        await onOpenNotification(remoteMessage, navigation)
                    }
                } catch (error) {
                    console.log('error', error)
                }
        ...
        this.messageListener = messaging().onMessage(async remoteMessage => {
            console.log("[FCM Service] A new FCM message arrived!", remoteMessage.notification.title)
